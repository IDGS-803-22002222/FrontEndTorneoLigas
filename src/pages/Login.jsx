    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-20 w-full max-w-md mx-4">
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-10 border border-gray-100">
          ...
          <button className="w-full text-gray-900 font-bold py-2.5 sm:py-3 rounded-xl border border-gray-300 hover:bg-gray-50 hover:border-gray-900 transition-all flex items-center justify-center gap-2 text-sm sm:text-base">
            <svg
              className="w-5 h-5"
              fill="none"
              stroke="currentColor"
